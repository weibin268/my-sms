 ...
 */
public class CmppCommandIdValues {

    public static final long CMPP_CONNECT = 0x00000001L;//请求连接

    public static final long CMPP_CONNECT_RESP = 0x80000001L;//请求连接应答

    public static final long CMPP_TERMINATE = 0x00000002L;//终止连接

    public static final long CMPP_TERMINATE_RESP = 0x80000002L;//终止连接应答

    public static final long CMPP_SUBMIT = 0x00000004L;//提交短信

    public static final long CMPP_SUBMIT_RESP = 0x80000004L;//提交短信应答

    public static final long CMPP_ACTIVE_TEST = 0x00000008L;//激活测试

    public static final long CMPP_ACTIVE_TEST_RESP = 0x80000008L;//激活测试应答

    public static final long CMPP_DELIVER = 0x00000005L;//短信下发

    public static final long CMPP_DELIVER_RESP = 0x80000005L;//下发短信应答

    public static final long CMPP_QUERY = 0x00000006L;//发送短信状态查询

    public static final long CMPP_QUERY_RESP = 0x80000006L;//发送短信状态查询应答
